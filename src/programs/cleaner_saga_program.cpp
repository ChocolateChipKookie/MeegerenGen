...
#include "cleaner_saga_program.h"
...
void cleaner_saga_main(float cleaner_size)
{
    ...
    std::string image_src{ "/home/kookie/documents/Projects/MeegerenGen/images/istanbul.jpg"};
    ...
    bool running = true;
    meg::drawer_thread dt{csaga, 600, 400, "current_state", running,std::chrono::milliseconds{30}};
    dt.start();

    meg::ga_time_condition<meg::cps, std::chrono::minutes> timeCondition(std::chrono::minutes(20));

    csaga.run_condition(timeCondition);
